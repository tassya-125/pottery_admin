<template>
  <div class="production-process-container">
    <!-- 标题 -->
    <h2 class="page-title">生产工艺管理</h2>
    <p class="page-subtitle">管理生产工艺的相关信息，包括新增、修改、删除等操作。</p>
    ...
    <el-card class="form-card">
      <el-form :inline="true" :model="dataForm" @keyup.enter="getDataList()" class="search-form">
        ...
        <el-form-item>
          ...
          <el-button v-if="isAuth('generator:productionprocess:save')" type="success" icon="el-icon-plus" @click="addOrUpdateHandle()">新增</el-button>
          <el-button v-if="isAuth('generator:productionprocess:delete')" type="danger" icon="el-icon-delete" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
        </el-form-item>
      </el-form>
  ...
  methods: {
    ...
    deleteHandle(id) {
      ...
      this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/productionprocess/delete'),
          method: 'post',
